...
// Удаление информации о юридическом лице
$sqlDeleteJur = "DELETE FROM `арендатор юрлицо` WHERE `email` = '$em'";
$db->Execute($sqlDeleteJur);

// Удаление информации о физическом лице
$sqlDeleteFiz = "DELETE FROM `arendfiz` WHERE `email` = '$em'";
